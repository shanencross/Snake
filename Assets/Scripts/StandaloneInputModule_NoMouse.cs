...
// Commented out Line 179: ProcessMouseEvent();
namespace UnityEngine.EventSystems
{
	[AddComponentMenu("Event/Standalone Input Module")]
	public class StandaloneInputModule_NoMouse : PointerInputModule
	{
		...
		protected StandaloneInputModule_NoMouse()
		{}
		...
		public override bool IsModuleSupported()
		{
			...
			// to use StandaloneInputModule_NoMouse for non-touch input events.
